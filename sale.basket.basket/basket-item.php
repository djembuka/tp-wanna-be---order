...
<script id="basket-item-template" type="text/html">
	<tr class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}"
		id="basket-item-{{ID}}" data-entity="basket-item" data-id="{{ID}}" data-cur="{{CURRENCY}}">
		{{#SHOW_RESTORE}}
				...
				<div class="basket-items-list-item-notification-inner basket-items-list-item-notification-removed" id="basket-item-height-aligner-{{ID}}">
					...
					<div class="basket-items-list-item-removed-container">
						...
						<div class="basket-items-list-item-removed-block">
							...
							<span class="basket-items-list-item-clear-btn" data-entity="basket-item-close-restore-button" style="background-image: url( '<?=$templateFolder?>/images/return.svg' );"></span>
						</div>
					</div>
				</div>
			</td>
						...
						<div class="basket-item-block-image<?=(!isset($mobileColumns['PREVIEW_PICTURE']) ? ' d-none d-sm-block' : '')?>">
							...
							{{#SHOW_LABEL}}
								<div class="basket-item-label-text basket-item-label-big <?=$labelPositionClass?>">
									{{#LABEL_VALUES}}
										<div{{#HIDE_MOBILE}} class="d-none d-sm-block b-prop"{{/HIDE_MOBILE}} style="color: #ca3538; border-color: #ca3538;">
											{{NAME}}
										</div>
									{{/LABEL_VALUES}}
								</div>
			...
			if ($useSumColumn)
			{
				...
				<td class="basket-items-list-item-price<?=(!isset($mobileColumns['SUM']) ? ' d-none d-sm-block' : '')?>">
					<div class="basket-item-block-price">
						...
						<div class="basket-item-price-title">
							<?=Loc::getMessage('SBB_BASKET_ITEM_TOTAL')?>
						</div>
